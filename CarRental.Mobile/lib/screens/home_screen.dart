...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final _subtitles = const [
    'تجربة قيادة بمستوى مختلف',
    'كل رحلاتك في مكان واحد',
          ...
          child: Column(
            children: [
              LuxuryTopBar(
                ...
                action: _topAvatar(auth.username),
              ),
              Expanded(
  ...
  Widget _topAvatar(String? username) => Container(
    ...
    child: Text(
      (username ?? 'A').substring(0, 1).toUpperCase(),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'مرحبًا بك، ${username ?? 'عميلنا العزيز'}',
              style: const TextStyle(
                color: AppTheme.ink,
                fontSize: 18,
                fontWeight: FontWeight.w900,
  ...
  Widget _drawerItem({
    ...
    decoration: BoxDecoration(
      color: selected ? AppTheme.primaryMuted : Colors.transparent,
      borderRadius: BorderRadius.circular(15),
    ),
    child: ListTile(
      contentPadding: const EdgeInsets.symmetric(horizontal: 12),
      leading: Icon(icon, color: selected ? AppTheme.primary : AppTheme.muted),
      title: Text(
        label,
        style: TextStyle(
          color: selected ? AppTheme.primary : AppTheme.body,
